...
export default async function Page({searchParams}:{searchParams:Record<string,string>}){
  ...
  return <div className="max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-[240px_1fr] gap-8">
    ...
    <div><h1 className="text-2xl font-bold">RUNNING</h1><p className="text-sm text-neutral-500">{content.length} san pham</p><div className="mt-6"><ProductGrid products={content}/></div></div>
  </div>;
}
